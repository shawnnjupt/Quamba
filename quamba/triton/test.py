...
# _USE_FXP_EXP = os.getenv("QUAMBA_FXP_EXP", "0") == "1"
# _USE_FXP_SOFTPLUS = os.getenv("QUAMBA_FXP_SOFTPLUS", "0") == "1"
# _USE_FXP_SILU = os.getenv("QUAMBA_FXP_SILU", "0") == "1"
# _USE_FXP_LN = os.getenv("QUAMBA_FXP_LN", "0") == "1"
